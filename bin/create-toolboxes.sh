...
init_media() {
  ...
  toolbox run -c media sudo dnf install -y beets beets-plugins cuetools ffmpeg flac ImageMagick libjpeg-turbo-utils mkvtoolnix perl-Image-ExifTool shntool xorg-x11-drv-nvidia unrar youtube-dl
